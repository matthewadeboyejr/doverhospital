      ...
      <div className="flex items-center w-full lg:w-[55%]">
        <div className="space-y-4 sm:space-y-6 w-full">
          ...
          <div className="flex justify-center md:justify-start pt-2">
            <Link
              href="/about"
              className="bg-blue-900 font-semibold text-white px-6 py-3 sm:px-8 sm:py-4 text-sm sm:text-base rounded-lg hover:bg-blue-600 transition-all duration-300"
            >
              About Us
            </Link>
          </div>
